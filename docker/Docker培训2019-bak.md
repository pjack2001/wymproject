...
$ sudo docker run --name mysql01 -p 3306:3306 -e MYSQL_ROOT_PASSWORD=newcapec -d mysql

$ sudo docker inspect mysql01
$ sudo docker exec mysql01 env
PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
HOSTNAME=a5e8453146be
...
登录$ sudo docker exec -it mysql01 /bin/sh
退出Ctrl+D
